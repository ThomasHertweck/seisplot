...
__copyright__ = "(c) 2024-2025 Thomas Hertweck"
...
def toggle(alldata, **kwargs):
    ...
    for plottype='image'. In addition, there are two parameters to configure
    the toggle, namely 'interval' and 'repeat_delay'. Note that saving the
    animation to a file is not available as part of this function - a user
